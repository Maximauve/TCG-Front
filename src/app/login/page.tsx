          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              <button
                ...
                className="w-full flex items-center justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50 transition-colors text-black cursor-pointer"
              >
                <svg
